...
# from eris.modules.sql import warns_sql as warnssql
import eris.modules.sql.blacklist_sql as blacklistsql

# from eris.modules.sql import cust_filters_sql as filtersql
# import eris.modules.sql.welcome_sql as welcsql
import eris.modules.sql.locks_sql as locksql
import eris.modules.sql.notes_sql as sql

# from eris.modules.rules import get_rules
import eris.modules.sql.rules_sql as rulessql
from eris import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from eris.__main__ import DATA_IMPORT
from eris.modules.connection import connected
from eris.modules.helper_funcs.alternate import typing_action
from eris.modules.helper_funcs.chat_status import user_admin
from eris.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("eris{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("eris{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `eris-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("eris{}.backup".format(chat_id))  # Cleaning file
