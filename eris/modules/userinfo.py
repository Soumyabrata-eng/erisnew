...
import eris.modules.sql.userinfo_sql as sql
from eris import dispatcher, DRAGONS, DEV_USERS
...
def set_about_me(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if repl_user_id == bot.id and (
                user_id in DRAGONS or user_id in DEV_USERS):
...
def about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DRAGONS and sender_id not in DEV_USERS:
            message.reply_text(
